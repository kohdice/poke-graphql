...
type QueryResolver interface {
	Pokemon(ctx context.Context) (*model.Pokemon, error)
}
...
func (ec *executionContext) _Query_pokemon(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNPokemon2ᚖgithubᚗcomᚋkohdiceᚋpokeᚑgraphqlᚋinternalᚋgraphqlᚋmodelᚐPokemon(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNPokemon2githubᚗcomᚋkohdiceᚋpokeᚑgraphqlᚋinternalᚋgraphqlᚋmodelᚐPokemon(ctx context.Context, sel ast.SelectionSet, v model.Pokemon) graphql.Marshaler {
	return ec._Pokemon(ctx, sel, &v)
}

func (ec *executionContext) marshalNPokemon2ᚖgithubᚗcomᚋkohdiceᚋpokeᚑgraphqlᚋinternalᚋgraphqlᚋmodelᚐPokemon(ctx context.Context, sel ast.SelectionSet, v *model.Pokemon) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
